...
export function openPassword(){
    ...
    let showPassword = document.querySelector('#openClose') as HTMLDivElement
...
export async function btnLogin(){
    ...
    let writePassword = document.querySelector('#senha') as HTMLInputElement

    const emailValue:string = email.value
    const passwordValue:string = writePassword.value
