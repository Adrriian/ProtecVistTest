        ...
        <div class="w-80% flex flex-col  gap-8 m-4">
            ...
            <div class="flex flex-col gap-4 justify-center">
                <div class="flex flex-col  gap-2">
                    ...
                    <input id='email' class=" p-1 border-blue-700  text-slate-700 placeholder:text-slate-700 dark:text-slate-900 dark:placeholder:text-slate-900 dark:bg-white border-4 rounded outline-0 dark:border-blue-700 font-bold" for="email" type="text" placeholder="Digite seu Email" required>
                </div>
                <div class="flex flex-col   gap-2 " >
                    <label for="senha" class="text-2xl text-blue-700 font-bold dark:text-white">Senha</label>
                    <input id="senha" class=" p-1 border-blue-700 text-slate-700 placeholder:text-slate-700 dark:text-slate-900 dark:placeholder:text-slate-900 dark:bg-white rounded border-4 outline-0 dark:border-blue-700  font-bold" type="text" placeholder="Digite seu Email" required>
                </div>
            </div>
            <div class="flex flex-col gap-2 ">
