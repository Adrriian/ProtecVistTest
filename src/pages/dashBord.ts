...
export const dashBord = function plate(){
    return `
    <div class="container flex dark:bg-slate-900">
            <div id="menuArea" class="w-10 h-screen overflow-hidden gap-10 p-2 dark:bg-slate-900 z-2 transition-all duration-500 ease-linear  fixed ">
