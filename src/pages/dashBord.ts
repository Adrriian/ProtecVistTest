        ...
        <div class="bg-slate-900 text-white rounded-2xl max-w-[90%] max-h-[90dvh] box-border overflow-y-scroll">
            <div class="w-full">
                <div class=" mt-5 ml-5 mr-5 flex items-center justify-between">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 bg-white stroke-slate-900 rounded-2xl cursor-pointer close">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M6 18 18 6M6 6l12 12" />
                    </svg>
                </div>
                ...
                <div class="flex flex-col gap-5 p-5">
                    ...
                    <div class="grid grid-cols-1 gap-2 sm:flex">
                        <div class="flex items-center gap-2 bg-green-700/50 rounded-xl p-2 cursor-pointer sm:w-50">
                        ...
                        <div  class="flex items-center gap-2 bg-red-600/25 rounded-xl p-2 cursor-pointer sm:w-50" >
