    ...
    return `<div class="container flex min-h-screen items-center justify-center ">
        <div class="w-80% flex flex-col  gap-8 m-4">
            ...
            <div class="flex flex-col gap-4 justify-center">
                ...
                <div class="flex flex-col   gap-2 " >
                    <label for="plate" class="text-2xl text-blue-700 font-bold dark:text-white">Placa</label>
                    <input id="plate" class="z-1 p-1 w-full border-blue-700 text-slate-700 placeholder:text-slate-700 dark:text-slate-900 dark:placeholder:text-slate-900 dark:bg-white rounded border-4 outline-0 dark:border-blue-700  font-bold" type="Text" placeholder="Digite a Placa" >
                </div>
                <div class="flex flex-col   gap-2 " >
